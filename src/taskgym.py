...
class HaydenRiskTrial(gym.Env):
    ...
    """
    def __init__(self, offer_probs=(0.125, 0.4375, 0.4375), offer_amounts=(1,2,3), penalty_no_choice=-0.1, penalty_break_fixation=-0.1):
        ...
        self.epoch_durations = {'iti': 16, 'offer1': 8, 'offer2': 8, 'pause1': 12, 'pause2': 12, 'fixation': 2, 'choice': 1, 'feedback': 5}
